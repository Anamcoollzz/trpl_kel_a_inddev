...
<body>
	...
	<div class="super_container">
		...
		@include('frontend.beranda.kenapa-memilih-kami')
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-lg-row flex-column align-items-center justify-content-start">
						...
						@include('frontend.beranda.minggu-ini')
						@endif

						<!-- Featured -->
						<div class="featured" @if(count($mingguIni) == 0)style="width: 100%;"@endif>
							<div class="tabbed_container">
								...
								@include('frontend.beranda.list-produk',['data'=>$populer,'active'=>true])
								@include('frontend.beranda.list-produk',['data'=>$terbaru])
								@include('frontend.beranda.list-produk',['data'=>$seringDilihat])
							</div>
						</div>
		...
		@include('frontend.beranda.kategori-populer')

		@include('frontend.beranda.banner')

			...
			<div class="col-lg-10 offset-lg-1">
				<div class="contact_form_container">
					...
					<form onsubmit="simpan(event,this)" action="{{route('produk.store')}}" id="contact_form" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="col-md-6">
								@include('form.vertikal.input',['id'=>'nama','required'=>true,'label'=>'Nama Produk'])
							</div>
							<div class="col-md-6">
								@include('form.vertikal.select',['id'=>'id_kategori','required'=>true,'label'=>'Pilih Kategori','selectData'=>$kategori])
							</div>
							<div class="col-md-6">
								@include('form.vertikal.input-number',['id'=>'tahun_dibuat','required'=>true,'min'=>2000,'max'=>2050,'label'=>'Tahun Dibuat','value'=>date('Y')])
							</div>
							<div class="col-md-6">
								@include('form.vertikal.input-number',['id'=>'tahun_selesai_dibuat','required'=>true,'min'=>2000,'max'=>2050,'label'=>'Tahun Selesai Dibuat','value'=>date('Y')])
							</div>
							<div class="col-md-6">
								@include('form.vertikal.input-number',['id'=>'harga','required'=>true,'min'=>50000,'label'=>'Harga','value'=>50000])
							</div>
							<div class="col-md-6">
